...
//Int Items
	...
	public static final int MEMBERID_FORGROUP = REF_ID2;
	public static final int MEMBERID_FORTRIP = REF_ID2;// MemberId(For TripMember, GROUPMember) or PaidById(For Share)
 ...
 */
	...
	/**
	 * For TripMember/GroupMember database
	 * @param TripMemberId/GroupMember
	 * @param TripId/GroupId
	 * @param MemberId
	 */

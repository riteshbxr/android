...
//		Toast.makeText(getApplicationContext(), path, Toast.LENGTH_LONG).show();
		...
		DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
		    ...
		    public void onClick(DialogInterface dialog, int which) {
		        ...
		        case DialogInterface.BUTTON_POSITIVE:
		        		//new Helper.importTrip(path,(Activity) getApplicationContext()).execute();
		            break;
		...
		builder.setTitle("Import Group").setPositiveButton("Yes", dialogClickListener)
		    .setNegativeButton("No", dialogClickListener).setMessage("Do You want to import the group in the file?["+path.getPath()+"]").show();
		}
	}
	@Override
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(resultCode==RESULT_OK && requestCode==GROUP_IMPORT_INTENT)
		{
                ...
                {
                	//new Helper.importTrip(recievedFile,this).execute();
	...
	public boolean onItemLongClick(AdapterView<?> listView, View view, int pos,
		...
		intent.putExtra(DBinfo.CLM_TRIP_GROUPID, ((ListItemClass) listView.getItemAtPosition(pos)).toInt());
		startActivity(intent);
	...
	// Called when the user selects a contextual menu item
		...
		public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
			...
			//	Toast.makeText(getApplicationContext() ,"Finally deleted:"+aa.getAllChecked().size(),Toast.LENGTH_SHORT ).show();
				...
				if (lic == null)
					new UndoOptions(lstGroups,positions, Helper.getUndoCallback(getContentResolver(), new ArrayList<ListItemClass>(groupList), aa,Helper.GROUPS));
				else
			...
			case R.id.group_Context_Share:
				...
				Uri uri = Uri.parse("file://" + Helper.exportToFile(Helper.extractIdsfromList(aa.getAllChecked(),groupList)));
			...
			case R.id.group_Context_export:
				...
				Toast.makeText(getApplicationContext(), "Exported to" +Helper.exportToFile(Helper.extractIdsfromList(aa.getAllChecked(),groupList)).getPath(), Toast.LENGTH_LONG).show();
			return true;
			default:
				return false;
			}
